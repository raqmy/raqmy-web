        ...
        <div className="flex justify-between items-center min-h-20 gap-4">
          ...
          <div className="flex items-center gap-2 md:gap-4 shrink-0">
            <select
              ...
              className="block rounded-lg border border-gray-200 bg-white px-2 sm:px-3 py-2 text-xs font-semibold text-gray-700 hover:bg-gray-50 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-100"
            ...
            {user && profile ? (
              <>
                <button
                  ...
                  className="flex items-center gap-2 px-3 md:px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-100 rounded-lg transition-colors"
                >
                ...
                <button
                  ...
                  className="flex items-center gap-3 px-2 md:px-4 py-2 hover:bg-gray-100 rounded-lg transition-colors"
                >
                  <div className="w-8 h-8 rounded-full overflow-hidden bg-blue-600 flex items-center justify-center relative shrink-0">
                    {renderProfileAvatar()}
              ...
              <div className="flex items-center gap-2 md:gap-3">
                <button
                  ...
                  className="px-3 md:px-6 py-2 text-sm font-medium text-blue-600 hover:bg-blue-50 rounded-lg transition-colors"
                >
                  تسجيل الدخول
                </button>
                ...
                <button
                  ...
                  className="px-3 md:px-6 py-2 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 rounded-lg transition-colors"
                >
                  ابدأ الآن
                </button>
              </div>
